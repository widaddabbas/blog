...
In 2023 I wrote one paper on category theory and another in theoretical ecology, accidentally making generality my home. The trouble with a home as big as generality is that I struggle to ever leave;<!--more--> despite knowing there can be no whole without its parts, I have forgotten how to pursue specifics[^1].
...
So, please enjoy this step by step account of a specific book _Cognitive Hypnotherapy[^3]_ by a specific individual _Trevor Silvester_.
...
[^6]: I omit the details so as not to rob Silvester of potential students.

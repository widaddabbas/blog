...
I was about to inaugurate this blog with an essay on losing my generality whilst likening the notion to that of talking about going for a walk, versus the specificity of setting one foot in front of the other to actually walk it. In the current socioeconomic climate however, I think the directions in which we choose to walk are more important than how far we individually go;<!--more-->

As with my desire to provoke macroscopic change using ecology, and my realisation that the limits are in fact socioeconomic, I realise that the limitations to my walking are perhaps tied mor


using specific techniques from Trevor Sylvester's notion of Cognitive Hypnotherapy[^1]. Whilst losing the generality of talking about going for a walk, versus the specificity of setting one foot in front of the other to actually walk it hasn't lost it's appeal,
...
identifying the associated trance phenomena **_-(1) dissociation from the real world and time (2) age progression to blindly walking in a straight line_-** as well as the underlying problem patterns **_-structure and consequence-_**. i.e. my walking muscles have atrophed s.t. WLOG is about building those muscles
**for optimism: 1. positive hallucination of bad and negative hallucinations of good. 2. age progression to terrible things 3. **
...
[^1]: Silvester, T. (2010). Cognitive hypnotherapy what’s that about and how can I use it?: two simple questions for change. Matador.

...
[^8]: The qualities which form our pereception of a thought loosely partition as: Audio (direction, diegesis, volume, pitch, cadence) Visual (saturation, distance, brightness, size, association, framing, motion, dimension) Kinaesthetic (location, volume, shape, intensity, movement, temperature, weight)

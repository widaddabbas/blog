...
_**2. Solution State:**_ When attempting to learn or create something specific and encountering any obstacle, I am unworried to complete the task with presence and the understanding that I can later pursue neglected obstacle if necessary and comforted that the gains will be valuable regardless.

_**3. Intervention:**_ Of Silvester's proposed interventions, Spinning and Anchoring seem most obvious. In light of this problem, I will choose only spinning whilst reserving anchoring for the pursuit of creating a non-specific downregulator and upregulator in future.

  _Spinning_

"get comfy... I want you to think back to a time when you encountered an obstacle whilst pursuing a specific, well justified task... now think of the feeling which is urging you to quit this task...
...
Continue like this until the desired feeling is reached.

### sealing the deal (Post Hypnotic Suggestion)

Following any intervention...
Change-Link pattern:
• Asks the unconscious to look back between now and the last session at
all the things that have led to the improvements they’ve noticed and use
them to anticipate the next range of things that mean the improvement
is continuing i.e. linking the changes already noticed to the changes that
might be anticipated.
• Use the TAOTM where the changes noticed become the cause of the pos-
itive changes that will be noticed i.e. the effect.
• If your clients brain is primed to notice those things around them that
equal evidence of growth then it consolidates the incepted idea that your
